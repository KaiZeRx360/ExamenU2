...
<body>
    <div class="container mt-4">
        <div class="text-center mb-4">
            <h1 class="text-dark">Bienvenido, <?php echo $_SESSION['usuario']; ?></h1>
        </div>
    </div>

    <div class="container mt-5">
        <h2 class="text-dark text-center">CRUD ALUMNOS</h2>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <h3 class="text-dark">Lista de Alumnos</h3>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formActualizarAlumno">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Actualizar Alumno</button>
                    </form>
                </div>
            </div>
        </div>
